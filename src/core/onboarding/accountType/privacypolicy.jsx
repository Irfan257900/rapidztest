...
const PrivacyPolicy = ({ accountType }) => {
  ...
  const fetchPrivacyPolicy = async () => {
    ...
    if (accountType === "Personal") {
      url = `/api/v1/PrivacyPolicy?Type=personal`
    } else if (accountType === "Business") {
      url = `/api/v1/PrivacyPolicy?Type=business`
  ...
  return (
    <>
      ...
      <div>
        ...
        {!content && <AppEmpty description="No Privacy Policy Found!" className="mt-8" />}
      </div>
    </>
  )
}
