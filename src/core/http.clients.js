...
const apiClient = createApiClient(window.runtimeConfig.VITE_CORE_API_END_POINT);
...
const uploadClient = createApiClient(window.runtimeConfig.VITE_CORE_API_END_POINT);
const paymentsWeb3Client = createApiClient(window.runtimeConfig.VITE_WEB3_API_END_POINT);
const loyaltyClient = createApiClient(window.runtimeConfig.VITE_API_LOYALITY_END_POINT);
...
const loyaltyAppClientMethods = createRequest( loyaltyClient );
