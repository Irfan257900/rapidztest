...
import { getPayinFiatTransactions } from "../../httpServices";
...
const PayinFiatTransactions = () => {
    ...
    const fetchTransactions = async () => {
        await getPayinFiatTransactions(setTransactions,setLoading, setErrorMsg);
    }
                        ...
                        {loading ? (
                            ...
                            transactions?.map((tx, idx) => (
                                <tr key={idx} className="border-t border-StrokeColor hover:bg-kendotdBghover transition">
                                    ...
                                    <td className="px-4 py-3">{tx.fee}</td>
...
export default PayinFiatTransactions;
