...
const cardsApiClient = createApiClient(window.runtimeConfig.VITE_API_CARDS_END_POINT);
...
const cardClientMethods = createRequest(APP_TYPE === 'custodial' ? cardsApiClient : paymentsWeb3Client);
