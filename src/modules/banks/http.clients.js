...
const apiClient = createApiClient(window.runtimeConfig.VITE_API_BANKS_END_POINT);
...
const paymentsWeb3Client = createApiClient(window.runtimeConfig.VITE_WEB3_API_BANKS_END_POINT);
